    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Upload any document and MiroFish generates millions of AI agents in a simulated world. Predict outcomes by injecting variables and observing emergent behaviors.
            </p>
            <p class="slogan-text">
              Rehearse the future in agent swarms<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="../assets/logo/MiroFish_logo_left.jpeg" alt="MiroFish - AI Prediction Engine Logo" class="hero-logo" />
          </div>
        ...
        <p class="section-desc">
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Millions of agents</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Extract seeds & Build knowledge graphs</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Generate agents & Configure simulation</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Execute multi-agent interactions</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Analyze results & Create insights</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with agents & Explore world</div>
                </div>
              </div>
            </div>
          </div>
